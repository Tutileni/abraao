...
public class Humain extends Joueur {
     ...
     * utilis� dans la version console du jeu
     */
    //	private void pause() {
    //		try {
    //			Thread.sleep(3000);
    ...
    //			}
    //		}
    //		int choix = IO.lireEntier(0, i);	// le choix doit �tre entre 0 et i
    ...
    public void jouerCarte() throws InterruptedException, ClassNotFoundException, InstantiationException,
        ...
        // main.nbCartes() > 1 : si la derni�re carte jou�e est une carte noire ! on n'a pas besoin
        // de s�l�ctionner une couleur ! il est gagnant quelque soit la couleur s�l�ctionn�e !
        // main.nbCartes() > 1 et non pas main.nbCartes() > 0 car la carte jou�e n'a pas encore �t� retir� de la main
        ...
        System.out.println( pseudo + " a jou� " + playedCard );
    }
